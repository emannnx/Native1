    ...
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      <SafeAreaView style={styles.container}>
        ...
        >
          ...
          >
            <Image
              source={require("../assets/search_.png")}
              style={{ width: "13%", height: "40%", resizeMode: "contain" }}
            />
            <TextInput
              ...
              >
                ...
                >
                  <Image
                    ...
                    style={{}}
                  />{" "}
                  <Text style={{ fontSize: 20, color: "#F08626" }}>2,000</Text>
                </View>
        ...
        >
          ...
          <Text style={{ fontSize: 20, fontWeight: "600", color: "#938DB5" }}>
            Popular
          </Text>
          <Text style={{ fontSize: 20, fontWeight: "600", color: "#938DB5" }}>
            New combo
